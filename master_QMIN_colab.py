...
forgame = 999 # forgame defines what kind of game/ forgameは、どのようなゲームを定義します
#----------------------------------
...
nn = [256,256,256] # how neural network is built(neuron in each layer) / ニューラルネットワークの構築方法（各層のニューロン）
